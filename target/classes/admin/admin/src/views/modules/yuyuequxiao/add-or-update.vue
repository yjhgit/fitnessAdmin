	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="取消说明" prop="quxiaoshuoming">
					<el-input v-model="ruleForm.quxiaoshuoming" placeholder="取消说明" clearable  :readonly="ro.quxiaoshuoming"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="取消说明" prop="quxiaoshuoming">
					<el-input v-model="ruleForm.quxiaoshuoming" placeholder="取消说明" readonly></el-input>
				</el-form-item>
