		...
		<div class="attr" :style='{"padding":"20px","position":"relative","flexWrap":"wrap","display":"flex"}'>
			...
			<div class="info" :style='{"width":"100%","padding":"10px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","margin":"0","background":"#F5F5F5"}'>
				...
				<div class="item" :style='{"width":"50%","padding":"10px","margin":"0 0 10px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"inline-block"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","display":"inline-block","width":"110px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>关联表id</div>
				...
				<div class="item" :style='{"width":"50%","padding":"10px","margin":"0 0 10px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"inline-block"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","display":"inline-block","width":"110px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>评论内容</div>
				...
				<div class="item" :style='{"width":"50%","padding":"10px","margin":"0 0 10px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"inline-block"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","display":"inline-block","width":"110px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>回复内容</div>
