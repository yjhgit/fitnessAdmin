		...
		<div class="attr" :style='{"padding":"20px","position":"relative","flexWrap":"wrap","display":"flex"}'>
			...
			<div class="info" :style='{"width":"100%","padding":"10px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","margin":"0","background":"#F5F5F5"}'>
				...
				<div class="item" :style='{"width":"50%","padding":"10px","margin":"0 0 10px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"inline-block"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","display":"inline-block","width":"110px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>订单编号</div>
					<div  :style='{"padding":"0 10px","color":"#666","display":"inline-block","width":"calc(100% - 110px)","fontSize":"14px","lineHeight":"40px","height":"40px"}'>{{detail.dingdanbianhao}}</div>
				</div>
				<div class="item" :style='{"width":"50%","padding":"10px","margin":"0 0 10px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"inline-block"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","display":"inline-block","width":"110px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>课程名称</div>
				...
				<div class="item" :style='{"width":"50%","padding":"10px","margin":"0 0 10px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"inline-block"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","display":"inline-block","width":"110px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>工号</div>
					<div  :style='{"padding":"0 10px","color":"#666","display":"inline-block","width":"calc(100% - 110px)","fontSize":"14px","lineHeight":"40px","height":"40px"}'>{{detail.gonghao}}</div>
				</div>
				<div class="item" :style='{"width":"50%","padding":"10px","margin":"0 0 10px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"inline-block"}'>
				...
				<div class="item" :style='{"width":"50%","padding":"10px","margin":"0 0 10px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"inline-block"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","display":"inline-block","width":"110px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>下单时间</div>
					<div  :style='{"padding":"0 10px","color":"#666","display":"inline-block","width":"calc(100% - 110px)","fontSize":"14px","lineHeight":"40px","height":"40px"}'>{{detail.xiadanshijian}}</div>
				</div>
				<div class="item" :style='{"width":"50%","padding":"10px","margin":"0 0 10px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"inline-block"}'>
					...
					<div  :style='{"padding":"0 10px","color":"#666","display":"inline-block","width":"calc(100% - 110px)","fontSize":"14px","lineHeight":"40px","height":"40px"}'>{{detail.yonghuming}}</div>
				</div>
				<div class="item" :style='{"width":"50%","padding":"10px","margin":"0 0 10px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"inline-block"}'>
				...
				<div class="item" :style='{"width":"50%","padding":"10px","margin":"0 0 10px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"inline-block"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","display":"inline-block","width":"110px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>手机</div>
				...
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#BECCBA","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="isAuth('xuankexinxi','打卡')" @click="onAcross('dakaxinxi','','','')" type="warning">打卡</el-button>
				</div>
			</div>
