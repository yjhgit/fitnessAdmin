...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","alignItems":"center","borderRadius":"10px","flexWrap":"wrap","background":"#BECCBA","display":"flex","width":"100%","height":"auto"}'>
	  ...
	  <el-button v-if="isAuth('jianshenshangpin','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"0 10px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#000","width":"auto","fontSize":"14px","lineHeight":"42px","height":"42px"}' type="primary" @click="add('/index/jianshenshangpinAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	...
	<div class="list" :style='{"margin":"0 0 10px"}'>
		...
		<div class="list1 index-pv1" :style='{"width":"100%","padding":"0","flexWrap":"wrap","justifyContent":"space-between","display":"flex","height":"auto"}'>
			<div :style='{"boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","margin":"10px 0","overflow":"hidden","borderRadius":"10px","background":"#fff","display":"inline-block","width":"24%","position":"relative","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click="toDetail(item)" class="list-item animation-box">
				...
				<div :style='{"padding":"0 10px","margin":"3px auto","color":"#fff","borderRadius":"20px","textAlign":"center","background":"#BECCBA","width":"80%","lineHeight":"32px","fontSize":"14px"}' class="name ">{{item.shangpinmingcheng}}</div>
				<div :style='{"padding":"0 10px","margin":"3px auto","color":"#fff","borderRadius":"20px","textAlign":"center","background":"#BECCBA","width":"80%","lineHeight":"32px","fontSize":"14px"}' class="name ">{{item.shangpinleixing}}</div>
			</div>
		</div>
