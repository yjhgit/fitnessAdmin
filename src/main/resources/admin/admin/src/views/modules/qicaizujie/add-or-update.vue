<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'" label="器材名称" prop="qicaimingcheng">
					<el-select :disabled="ro.qicaimingcheng" @change="qicaimingchengChange" v-model="ruleForm.qicaimingcheng" placeholder="请选择器材名称">
						<el-option
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.qicaimingcheng" label="器材名称" prop="qicaimingcheng">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="租借数量" prop="zujieshuliang">
					<el-input v-model="ruleForm.zujieshuliang" placeholder="租借数量" clearable  :readonly="ro.zujieshuliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="租借数量" prop="zujieshuliang">
					<el-input v-model="ruleForm.zujieshuliang" placeholder="租借数量" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="租赁说明" prop="zulinshuoming">
					<el-input v-model="ruleForm.zulinshuoming" placeholder="租赁说明" clearable  :readonly="ro.zulinshuoming"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="租赁说明" prop="zulinshuoming">
					<el-input v-model="ruleForm.zulinshuoming" placeholder="租赁说明" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="租借人" prop="zujieren">
					<el-input v-model="ruleForm.zujieren" placeholder="租借人" clearable  :readonly="ro.zujieren"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="租借人" prop="zujieren">
					<el-input v-model="ruleForm.zujieren" placeholder="租借人" readonly></el-input>
				</el-form-item>
	...
	methods: {
		...
		init(id,type) {
			...
			qicaimingchengChange () {
				this.$http({
					url: `follow/jianshenqicai/qicaimingcheng?columnValue=`+ this.ruleForm.qicaimingcheng,
					method: "get"
				}).then(({ data }) => {
					if (data && data.code === 0) {
						if(data.data.qicaileixing){
							this.ruleForm.qicaileixing = data.data.qicaileixing
						}
					} else {
						this.$message.error(data.msg);
					}
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `qicaizujie/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.qicaizujieCrossAddOrUpdateFlag = false;
						 this.parent.search();
