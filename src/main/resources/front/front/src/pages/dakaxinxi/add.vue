...
<div :style='{"width":"1000px","padding":"20px","margin":"10px auto","position":"relative","background":"#D8D8D8"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 2% 10px","display":"inline-block"}' label="打卡时间" prop="dakashijian" disabled>
              <el-date-picker
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 2% 10px","display":"inline-block"}' label="打卡内容" prop="dakaneirong">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="打卡内容"
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 2% 10px","display":"inline-block"}' label="地址" prop="fulladdress">
...
import { Loading } from 'element-ui';
  export default {
    data() {
      return {
        ...
        rules: {
          ...
          dakaneirong: [
            { required: true, message: '打卡内容不能为空', trigger: 'blur' },
          ],
          dakashijian: [
          ],
          xingming: [
    ...
    // 多级联动参数
      // 多级联动参数
      info(id) {
        this.$http.get('dakaxinxi/detail/${id}', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
                  ...
                  params: params
                     ...
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          this.$http.post('dakaxinxi/add', this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
                                      message: '操作成功',
                                      type: 'success',
