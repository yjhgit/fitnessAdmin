...
public class JianshenjiaolianController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		JianshenjiaolianEntity u = jianshenjiaolianService.selectOne(new EntityWrapper<JianshenjiaolianEntity>().eq("gonghao", username));
    ...
    public R register(@RequestBody JianshenjiaolianEntity jianshenjiaolian){
    	...
    	JianshenjiaolianEntity u = jianshenjiaolianService.selectOne(new EntityWrapper<JianshenjiaolianEntity>().eq("gonghao", jianshenjiaolian.getGonghao()));
		if(u!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        JianshenjiaolianEntity u = jianshenjiaolianService.selectById(id);
