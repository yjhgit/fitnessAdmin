...
public class JiaolianyuyueServiceImpl extends ServiceImpl<JiaolianyuyueDao, JiaolianyuyueEntity> implements JiaolianyuyueService {
    ...
    @Override
    public JiaolianyuyueEntity queryCoachSchedule(JiaolianyuyueEntity jiaolianyuyue) {
        return baseMapper.queryCoachSchedule(jiaolianyuyue);
    }

    @Override
    public void cancel(Long id, Long userId) {
        baseMapper.cancel(id, userId);
    }
